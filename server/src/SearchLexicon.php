...
final class SearchLexicon
{
    ...
    private const GROUPS = [
        ...
        // 2026-09-11 무결과 검색어 실측 보강(search_logs 상위 30 + 저결과 15)
        ['연계','연동','인터페이스','interface','기관연계','integration','통합연계','데이터연계','api연계','연계체계'],
        ['이관','마이그레이션','migration','전환','이전','데이터이관','데이터전환','이행'],
        ['수집','데이터수집','크롤링','crawling','스크래핑','scraping','웹크롤링','채집','collect','수집기'],
        ['기관','공공기관','관공서','정부','부처','기관연계','institution','agency'],
        ['표준','표준화','규격','standard','standardization','표준용어','인증','규정'],
        ['아키텍처','architecture','구성도','시스템구성','구조','설계','구조도'],
        ['로드맵','roadmap','일정','계획','마일스톤','milestone','추진일정','스케줄','schedule'],
        ['가교','다리','bridge','연결','브릿지','매개','중계'],
        ['안정화','안정','운영','stabilization','stable','정착'],
        ['산출물','결과물','문서','보고서','deliverable','output','report','성과물'],
        ['해양','바다','해수','ocean','sea','marine','수산'],
        ['스티커','라벨','태그','배지','badge','label','sticker','뱃지'],
        ['정렬','순서','sort','order','정리','align'],
        ['샘플','예시','견본','sample','example','예제','데모'],
        ['봇','로봇','챗봇','bot','robot','chatbot','자동화','automation'],
        ['포털','홈페이지','웹사이트','portal','website','사이트','web'],
        ['전문가','컨설턴트','인력','expert','consultant','전문인력','담당자','실무자','사람'],
        ['이슈','문제','장애','issue','problem','리스크','risk','오류'],
        ['판정','판단','검증','승인','judgment','verification','심사','평가','검토'],
        ['주고받기','교환','전송','exchange','transfer','송수신','공유','연동'],
        ['msa','마이크로서비스','microservice','모듈','module','분산'],
        ['먼저','우선순위','선점','priority','우선','first','1순위'],
        ['질주','달리기','속도','run','speed','running','가속','러너'],
        ['이해','학습','교육','understanding','learning','training','습득'],
        ['배너','테두리','프레임','frame','banner','border','띠','상단바'],
        ['풍선','말풍선','풍선말','balloon','speech bubble','bubble','대화'],
        ['느낌표','경고','주의','alert','warning','exclamation','알림','강조'],
        ['레고','블록','block','lego','조립','모듈'],
        ['연구소','연구','실험실','lab','laboratory','research','연구원'],
    ];
